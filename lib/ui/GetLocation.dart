...
class _GetLocationState extends State<GetLocation> {
  ...
  void initState() {
    ...
    super.initState();
    //getCurrentPosition();
    double lat = double.parse('	24.750959');
        double lng = double.parse('46.80547680000001');
        _addMarker(new LatLng(lat,lng));
        _redirctCameraPosition(
            CameraPosition(
                bearing: 192.8334901395799,
    ...
    //   if(user.latLang != null){
    //     double lat = double.parse(user.latLang.split(",")[0]);
    //     double lng = double.parse(user.latLang.split(",")[1]);
    //     _addMarker(new LatLng(lat,lng));
    //     _redirctCameraPosition(
    //         CameraPosition(
    //             bearing: 192.8334901395799,
