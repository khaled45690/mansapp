...
//         child: Column(
//                   children: prepareData.map<Widget>((ItemModel category){
//                      return   Column(
//                       children: <Widget>[
//                         Container(
//                           height: 160.0,
...
//  List<BodyModel> prepareBody = <BodyModel>[
//     BodyModel(price: 3,quantity: 6),
//     BodyModel(price: 3,quantity: 6),
//     BodyModel(price: 3,quantity: 6),
//   ];
//   final List<ItemModel> prepareData = <ItemModel>[
//     ItemModel(header: 'Milk', bodyModel:<BodyModel>[BodyModel(price: 3,quantity: 6),BodyModel(price: 3,quantity: 6)]),
//     ItemModel(header: 'Coconut', bodyModel: <BodyModel>[BodyModel(price: 3,quantity: 6),BodyModel(price: 3,quantity: 6)]),
//     ItemModel(header: 'Watch', bodyModel: <BodyModel>[BodyModel(price: 3,quantity: 6),BodyModel(price: 3,quantity: 6)]),
//     ItemModel(header: 'Cup', bodyModel: <BodyModel>[BodyModel(price: 3,quantity: 6),BodyModel(price: 3,quantity: 6)]),
//   ];
// }
// class ItemModel {
//   bool isExpanded;
...
class TestFamousV1 extends StatefulWidget {
  // TestFamousV1({Key key, this.shoppingCart}) :super(key: key);
  // ShoppingCartVM shoppingCart;
  @override
  _TestFamousV1State createState() => _TestFamousV1State();
}

class _TestFamousV1State extends State<TestFamousV1> {
            ...
            return ExpansionPanelList(
              ...
              children: [
                ExpansionPanel(
                  ...
                  //           //   child: ListView(
                  //           //   padding: EdgeInsets.symmetric(vertical: 8.0),
                  //           //   // children: prepareData[index].bodyModel.SocialFamousVMs.map((SocialFamousVM socialItem) {
